...
### 2. 核心架构与 IO 指标 (Architecture & I/O)
> **核心研究点**：通过 IO 数据证明 MapReduce 的“迭代开销”与 Giraph 的“内存优势”。
...
### 3. 通信与网络指标 (Communication & Synchronization)
...
### 4. 任务调度与长尾指标 (Scheduling & Stragglers)
